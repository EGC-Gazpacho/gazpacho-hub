...
Revision ID: a4fed84c6174
Revises: 3914265a662c
Create Date: 2024-12-18 17:09:05.553419
...
revision = 'a4fed84c6174'
down_revision = '3914265a662c'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('number_of_products', sa.Integer(), nullable=True),
    sa.PrimaryKeyConstraint('id')
    )
